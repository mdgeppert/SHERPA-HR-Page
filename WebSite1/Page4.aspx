                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Client Name"><%--ClientName--%>
                                <ItemTemplate>
                                    ...
                                    <asp:DropDownList ID="ddlClientNameText" runat="server" AutoPostBack="true" OnSelectedIndexChanged="billableText" AppendDataBoundItems="true"></asp:DropDownList>
                            ...
                            <asp:TemplateField HeaderText="Billable"><%--Billable--%>
                                <ItemTemplate>
                                    <asp:TextBox runat="server" ID="continueTbxBillable" Text='<%# Bind("Billable") %>'   AutoPostBack="true" ReadOnly="false" />
